...
address= "xpath@@//input[@id='addresstext'][@placeholder='Enter your address']"
...
continue_to_catalog = "xpath@@//div[@class='form-group']/button[contains(text(),'Continue')]"
date_selector="xpath@@//label[@for='delivery-datepicker']"
